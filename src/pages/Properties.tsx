          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="flex-1 max-w-md">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-luxury-stone w-5 h-5" />
                <Input
                  type="text"
                  placeholder="Search properties or locations..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="pl-10 h-12 border-luxury-stone/30 focus:border-luxury-gold"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <Filter className="w-5 h-5 text-luxury-stone" />
                <select
                  value={selectedLocation}
                  onChange={(e) => setSelectedLocation(e.target.value)}
                  className="px-4 py-2 h-12 border border-luxury-stone/30 rounded-md focus:border-luxury-gold focus:outline-none bg-white"
                >
        ...
        <div className="container-custom section-padding">
          ...
          {filteredProperties.length > 0 ? (
            ...
            <div className="text-center py-20">
              <div className="text-4xl font-playfair text-luxury-stone mb-4">
                No properties found
              </div>
              <p className="text-luxury-stone text-lg mb-8">
